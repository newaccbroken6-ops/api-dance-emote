...
async def EncRypTMajoRLoGin(open_id, access_token):
    ...
    major_login.client_version = "1.118.11"
            ...
            while True:
                ...
                if data2.hex().startswith('0500') and len(data2.hex()) > 1000:
                    try:
                        ...
                        message = f"""[B][C]{get_random_color()}* LINUX *

{get_random_color()}-------------------
[00FF00]تم اخت.ر.اق السكواد من قبل LINUX
{get_random_color()}-------------------"""
...
async def MaiiiinE():
    Uid, Pw = '4333619229','12_6VKHN_BY_SPIDEERIO_GAMING_RF6A8'
